...
FLAN_PROMPTS = {
    ...
    "squad_v2": [
        ("{context}\n\nPlease answer a question about this " #{title}:\n\n
    ...
    "openbookqa": [
        ...
        ("Use evidence from the fact that {fact} to answer this question: "
         "\"{question}\"\n\n{options_}", "{answer}"),
        ("Fact: {fact}\nQuestion: {question}\n\n Which one below is the " #What's the
         "answer?\n\n{options_}", "{answer}"),
    ...
    "msmarco":[
        ("Passage: {context}\n Given the context, can the following information be retrieved from the context?\n\n {options_}", "{answer}")
    ]
}

#https://github.com/google-research/FLAN/blob/main/flan/v2/task_configs_v1.py

PROMPT_OPTIONS = {
    'mnli_mismatched':['yes', 'it is not possible to tell', 'no'],
    'mnli_matched':['yes', 'it is not possible to tell', 'no'],
    'mnli':['yes', 'it is not possible to tell', 'no'],
    'nli_fever':['yes', 'it is not possible to tell', 'no'],
    'axb':['yes', 'no'],
    'axg': ['yes', 'no'],
    'cb':['Yes', 'No', 'It\'s impossible to say'],
    'rte':['yes', 'no'],
    'wnli':['no', 'yes'],
    'sick':['0', '1', '2', '3', '4', '5'],
    'stsb':['0', '1', '2', '3', '4', '5'],
    'anli_1':['Yes', 'It\'s impossible to say', 'No'],
    'anli_2':['Yes', 'It\'s impossible to say', 'No'],
    'anli_3':['Yes', 'It\'s impossible to say', 'No'],
    'anli':['Yes', 'It\'s impossible to say', 'No'],
    'snli':['yes', 'it is not possible to tell', 'no'],
    'vitaminc':['yes', 'it is not possible to tell', 'no'],
    'mrpc':['no', 'yes'],
    'paws':['no', 'yes'],
    'paws_wiki':['no', 'yes'],
    'sem_eval':['no', 'yes'],
    ...
    'glue_qqp':['no', 'yes'],
    'msmarco': ['no', 'yes'],
    'race_m':[], ### has its own options
    'race_h':[],
    'eraser_multi_rc':['no', 'yes'],
    'boolq':['no', 'yes'],
    'dream':[], # choices
    'quartz':[], # choices
    'quail':[], # choices
...
PROMPT_MAPPING = {
    ...
    'paws_qqp':'paws_wiki',
    'qqp':'glue_qqp',
    'race_m':'openbookqa', ### has its own options
    'race_h':'openbookqa',
    'eraser_multi_rc':'multirc',
    'boolq':'bool_q',
    'dream':'openbookqa', # choices
    'quartz':'openbookqa', # choices
    'quail':'openbookqa', # choices
    'sciq':'openbookqa',
    'gap':'gap'
}